...
$stmt = $conn->query("
    SELECT b.id, u.username, s.name, b.booking_datetime, b.status
    FROM bookings b
...
<h2>Bookings</h2>
<a href="bookings_create.php" class="btn btn-primary mb-3">Add Booking</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="bookings_delete.php?id=<?= $b['id'] ?>" class="btn btn-sm btn-danger"
